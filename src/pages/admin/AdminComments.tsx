...
const AdminComments = () => {
  ...
  return (
    <AdminLayout title="Gerenciar Comentários">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Comentários ({filteredComments.length})</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <div>
                            <span className="font-medium">{comment.author_name || "Anônimo"}</span>
                            ...
                            {!isApproved && (
                              <span className="ml-2 px-2 py-0.5 bg-orange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-300 text-xs font-medium rounded">
                                Pendente
                              </span>
                            )}
                          </div>
